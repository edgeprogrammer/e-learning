            ...
            "slidesToShow": 1
                ...
                <div class="slide-item bg-1 animation-style-01">
                    <div class="slide-content">
                        <span class="intro">Welcome to Edge Programmers </span>
        ...
        <div id="welcome" class="introduction-area">
            <div class="container">
                <div class="section-title pb-5">
                    ...
                    <h6 class="heading mb-0">We are the Startup of E-learning Portal</h6>
                    <h2 class="sub-heading mb-0">Welcome to <span>Edge</span> Programmers</h2>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="introduction-img_area">
                            <div class="inner-img">
                                <img class="img-full" src="assets/images/logo/23.png" alt="Introduction Image">
                                <div class="popup-btn">
                                    <a class="popup-vimeo" href="https://www.youtube.com/watch?v=gxaw43EUMxc">
                        ...
                        "slidesToShow": 1
                            ...
                            <div class="intro-item">
                                <div class="intro-content">
                                    <h3 class="heading mb-0">Get know About Edge Programmers</h3>
                    ...
                    <div class="col-lg-8">
                        <div class="introduction-area-2">
                            <h2 class="heading mb-0">Welcome to
                                <span>Edge Programmers</span>
                                a prestigious Youtube Channel for Improving Programming skills.
                            </h2>
...
<form action="https://000webhostapp.us10.list-manage.com/subscribe/post?u=c3f6b2e7b3b0274df7fc17212&amp;id=dd4f7a01cd" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_c3f6b2e7b3b0274df7fc17212_dd4f7a01cd" tabindex="-1" value=""></div>
                        ...
                        "slidesToShow": 1
                            ...
                            <div class="slide-item">
                                <div class="single-item">
                                    ...
                                    <div class="single-item_content">
                                        <p class="short-desc mb-0">
                                            I find it satisfactory with the results of our kids since they entered Edge Programmers. Good quality.
                                        </p>
        ...
        <div class="instagram-area">
            <div class="container-fluid p-0 overflow-hidden">
                ...
                <div class="instagram-title">
                    ...
                    <h6 class="sub-heading text-uppercase mb-0">Follow us on <strong>edgeprogrammers</strong>
                    </h6>
                </div>
            </div>
        </div>
...
<!-- Mirrored from demo.hasthemes.com/ademy-preview/ademy/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2020 04:20:31 GMT -->
</html>
