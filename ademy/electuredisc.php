                ...
                <?PHP
                  ...
                  if(mysqli_num_rows($query)>0)
                  {
                    ...
                    while ($row = mysqli_fetch_assoc($query))
                    {
                      ...
                      echo "<td> <img src='data:image;base64,".$row['gimg']."' alt='img 1 not fount' width='100px' height='100px'/> </td>";
                      echo "<td> <a href='gUpdate.php?id=$row[gpid]'> <div class='btn btn-danger'> Update </div> </a> </td>";
                      echo "</tr>";
