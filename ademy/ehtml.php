            ...
            <section class="products-area pt-100 pb-70">
                <div class="container">
                  <div class="section-title">
                      <span class="sub-title">See HTML E-Lectures</span>
                      <h2>ALL HTML E-LECTURES</h2>
                  </div>
                  <div class="row">
                  <!-- product start -->
                  <?PHP
                  $sql = "SELECT * FROM electure WHERE gsubCategory='HTML'";
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="ehtml.php?id=<?PHP echo $row['id']; ?>">
                                  <?PHP echo "<td> <img src='data:image;base64,".$row['eimg']."' class='main-image' alt='image'/> </td>"; ?>
                                </a>
                            </div>
                          <div class="products-content">
                              <h3><a href="https://www.youtube.com/watch?v=Wx4Rbom3YVg&t=29s?id=<?PHP echo $row['id']; ?>"> <?PHP echo $row['gdesc']; echo "&nbsp;(".$row['gcategory'].")"; ?></a></h3>
                      <!--         <div class="price">
                                <span class="new-price"> Available </span>
                              </div>
                       -->         <a href="https://www.youtube.com/watch?v=Wx4Rbom3YVg&t=29s" class="add-to-cart">Watch Full Video</a>
                          </div>
                        </div>
                      </div>
